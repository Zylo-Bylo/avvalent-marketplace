...
CREATE TABLE IF NOT EXISTS public."Notification" (
  ...
  CONSTRAINT "Notification_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"(id) ON UPDATE CASCADE ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS public."Order" (
  ...
  CONSTRAINT "Order_vendorId_fkey" FOREIGN KEY ("vendorId") REFERENCES "Vendor"(id) ON UPDATE CASCADE ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS public."Product" (
  ...
  CONSTRAINT "Product_subcategoryId_fkey" FOREIGN KEY ("subcategoryId") REFERENCES "Subcategory"(id) ON UPDATE CASCADE ON DELETE SET NULL,
  CONSTRAINT "Product_vendorId_fkey" FOREIGN KEY ("vendorId") REFERENCES "Vendor"(id) ON UPDATE CASCADE ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS public."Review" (
  ...
  "comment" TEXT,
  "createdAt" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP NOT NULL,
  CONSTRAINT "Review_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"(id) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT "Review_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"(id) ON UPDATE CASCADE ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS public."Subcategory" (
  ...
  "altText" TEXT,
  "archivedAt" TIMESTAMP(6),
  CONSTRAINT "Subcategory_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"(id) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public."Vendor" (
  ...
  "createdAt" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP NOT NULL,
  "updatedAt" TIMESTAMP(3) NOT NULL,
  CONSTRAINT "Vendor_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"(id) ON UPDATE CASCADE ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS public."Wishlist" (
  ...
  "productId" TEXT NOT NULL,
  "createdAt" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP NOT NULL,
  CONSTRAINT "Wishlist_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"(id) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT "Wishlist_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"(id) ON UPDATE CASCADE ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS public."reseller_earnings" (
  ...
  CONSTRAINT "reseller_earnings_reseller_id_fkey" FOREIGN KEY (reseller_id) REFERENCES reseller_profile(reseller_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public."reseller_shared_products" (
  ...
  "created_at" TIMESTAMP(6) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT "reseller_shared_products_reseller_id_fkey" FOREIGN KEY (reseller_id) REFERENCES reseller_profile(reseller_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public."vendor_approvals" (
  ...
  CONSTRAINT "vendor_approvals_reviewed_by_fkey" FOREIGN KEY (reviewed_by) REFERENCES admin_users(id),
  CONSTRAINT "vendor_approvals_vendor_id_fkey" FOREIGN KEY (vendor_id) REFERENCES vendors(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public."wallet_transactions" (
  ...
  CONSTRAINT "wallet_transactions_wallet_id_fkey" FOREIGN KEY (wallet_id) REFERENCES wallets(wallet_id) ON DELETE CASCADE,
...
CREATE UNIQUE INDEX "ProductType_slug_key" ON public."ProductType" USING btree (slug);
...
CREATE UNIQUE INDEX "ProductType_subcategoryId_name_key" ON public."ProductType" USING btree ("subcategoryId", name);
...
CREATE UNIQUE INDEX "ReturnRefundRequest_orderId_key" ON public."ReturnRefundRequest" USING btree ("orderId");
...
CREATE UNIQUE INDEX "Subcategory_categoryId_name_key" ON public."Subcategory" USING btree ("categoryId", name);
CREATE UNIQUE INDEX "Subcategory_slug_key" ON public."Subcategory" USING btree (slug);
...
CREATE UNIQUE INDEX "VendorLedger_order_type_unique" ON public."VendorLedger" USING btree ("orderId", type) WHERE ("orderId" IS NOT NULL);
...
CREATE UNIQUE INDEX "delivery_otp_orderId_key" ON public.delivery_otp USING btree ("orderId");
CREATE INDEX IF NOT EXISTS "dispatch_images_orderId_idx" ON public.dispatch_images USING btree ("orderId");
CREATE UNIQUE INDEX logistics_tracking_number_key ON public.logistics USING btree (tracking_number);
CREATE INDEX IF NOT EXISTS idx_notifications_is_read ON public.notifications USING btree (is_read);
CREATE INDEX IF NOT EXISTS idx_notifications_user_id ON public.notifications USING btree (user_id);
CREATE UNIQUE INDEX "open_box_verification_orderId_key" ON public.open_box_verification USING btree ("orderId");
...
CREATE UNIQUE INDEX "order_verification_orderId_key" ON public.order_verification USING btree ("orderId");
CREATE UNIQUE INDEX "order_verification_verificationId_key" ON public.order_verification USING btree ("verificationId");
...
CREATE UNIQUE INDEX reseller_profile_referral_code_key ON public.reseller_profile USING btree (referral_code);
CREATE UNIQUE INDEX "return_requests_orderId_key" ON public.return_requests USING btree ("orderId");
...
CREATE UNIQUE INDEX "risk_assessment_returnRequestId_key" ON public.risk_assessment USING btree ("returnRequestId");
