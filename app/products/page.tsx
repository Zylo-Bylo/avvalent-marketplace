    ...
    <div className="min-h-screen max-w-full bg-[#f8f4ec] pb-20 text-[#241f18]">
      ...
      <main className="mx-auto max-w-7xl px-3 py-4 sm:px-4 sm:py-6">
        <div className="mb-4 rounded-sm border border-[#e7dcc8] bg-[#fffdf8] px-4 py-4 shadow-[0_8px_22px_rgba(42,35,25,0.06)]">
          ...
          <h1 className="mt-1 text-2xl font-normal text-[#241f18] md:text-3xl">
            Products
          </h1>
          <p className="mt-1 text-sm text-[#756a5e]">
            Browse curated marketplace products with category, price and stock filters.
          </p>
        </div>
        ...
        <div className="sticky top-[104px] z-30 mb-4 rounded-sm border border-[#e7dcc8] bg-[#fffdf8]/95 p-3 shadow-[0_10px_24px_rgba(42,35,25,0.08)] backdrop-blur lg:hidden">
          <div className="flex items-center justify-between gap-2">
            <button
              ...
              className="flex-1 rounded-full bg-[#241f18] px-4 py-2.5 text-xs font-medium uppercase text-[#fffaf1]"
            >
            ...
            <select
              ...
              className="min-w-0 flex-1 rounded-full border border-[#d9c7a6] bg-white px-3 py-2.5 text-xs font-medium text-[#5f4a28] outline-none focus:border-[#b58b3b]"
            >
        ...
        >
          <div className="flex items-center justify-between gap-3">
            ...
            {activeFilterCount > 0 && (
              <button
                ...
                className="text-sm font-medium text-[#8a6a30]"
              >
                Clear
              </button>
            )}
          ...
          <div className="mt-4 space-y-5">
            <input
              ...
              className="w-full border border-[#d9c7a6] px-3 py-3 text-sm outline-none focus:border-[#b58b3b]"
            />
            ...
            <select
              ...
              className="w-full border border-[#d9c7a6] px-3 py-3 text-sm outline-none focus:border-[#b58b3b] disabled:bg-stone-100"
            >
              <option value="">
        ...
        <section>
          <div className="mb-4 flex flex-col justify-between gap-3 border border-[#e7dcc8] bg-[#fffdf8] px-4 py-3 shadow-sm md:flex-row md:items-center">
            ...
            <Link
              ...
              className="rounded-full bg-[#241f18] px-4 py-2 text-sm font-medium text-[#fffaf1] hover:bg-[#3a3329]"
            >
              Sell a Product
            </Link>
          </div>
                ...
                const signal =
                  inventory?.isPreOrder
                    ...
                    : inventory?.allowBackorder || inventory?.stockStatus === "BACKORDER"
                      ? { label: "Backorder Available", className: "bg-[#eef0f4] text-[#4f463b]" }
                      : available <= 0
                        ...
                        <div>
                          ...
                          {product.mrp && product.mrp > product.price && (
                            <p className="text-[11px] text-stone-500 sm:text-xs">
                              ...
                              <span className="font-medium text-[#8a6a30]">
                                {product.discountPercent || 0}% off
                              </span>
                            </p>
                          )}
                        </div>
                        <p className="hidden text-[11px] font-medium text-[#756a5e] sm:block sm:text-xs">
          ...
          {!loading && hasMore && (
            <div className="mt-6 text-center">
              <button
                ...
                className="rounded-full bg-[#241f18] px-6 py-3 text-sm font-medium text-[#fffaf1] disabled:cursor-not-allowed disabled:opacity-60"
              >
